          ...
          {questions.map((q: any) => (
            ...
            >
              <dt className="text-lg">
                <button
                  className="flex items-start dark:tex-white text-black justify-between w-full text-left focus:outline-none"
              ...
              {q.active && (
                <dd className="mt-2 pr-12">
                  <input
                    ...
                    placeholder={"Ad your answer..."}
                  />

                  <span className="ml-6 flex-shrink-0">
                    <AiOutlineDelete
                      className="ark:text-white text-black text-[18px] cursor-pointer"
                      onClick={() => {
                        setQuestions((prevQuestions) =>
