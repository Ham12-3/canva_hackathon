...
userRouter.get("/logout", auth_1.isAuthenticated, (0, user_controller_1.authorizeRoles)("admin"), user_controller_1.logoutUser);
...
userRouter.get("/get-all-users", auth_1.isAuthenticated, (0, user_controller_1.authorizeRoles)("admin"), user_controller_1.getAllUsers);
userRouter.put("/update-user", auth_1.isAuthenticated, (0, user_controller_1.authorizeRoles)("admin"), user_controller_1.updateUserRole);
userRouter.delete("/delete-user/:id", auth_1.isAuthenticated, (0, user_controller_1.authorizeRoles)("admin"), user_controller_1.deleteUser);
